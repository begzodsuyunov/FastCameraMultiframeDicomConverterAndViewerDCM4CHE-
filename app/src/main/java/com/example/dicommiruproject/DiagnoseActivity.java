...
public class DiagnoseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCounter = findViewById(R.id.indexCount);

        btnPrevious = findViewById(R.id.btnPrevious);
        btnNext = findViewById(R.id.btnNext);
        btnLoad = findViewById(R.id.button);
        btnDicom = findViewById(R.id.btnDicom);
        ...
        btnDicom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void listDicom(DcmFile selectedDcmFile) {
        try {
            ...
            maxFrames = loadDataSet.getInt8(new TagId(0x0028, 0x0008), 0);
    ...
    private void updateCounter() {
        // Update the counter TextView with the current frame index and max frames
        String counterText = String.format("%d / %d", currentFrameIndex + 1, maxFrames);
